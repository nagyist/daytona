...
func (r ApiRegisterRunnerRequest) Execute() (*RunnerDTO, *http.Response, error) {
...
//
//	@return RunnerDTO
func (a *RunnerAPIService) RegisterRunnerExecute(r ApiRegisterRunnerRequest) (*RunnerDTO, *http.Response, error) {
	var (
