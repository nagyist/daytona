...
// Execute command
func (r ApiExecuteCommandRequest) Command(command ExecuteRequest) ApiExecuteCommandRequest {
	r.command = &command
	return r
}
...
/*
ExecuteCommand Execute command inside workspace project
...
*/
func (a *WorkspaceAPIService) ExecuteCommand(ctx context.Context, workspaceId string, projectId string) ApiExecuteCommandRequest {
	return ApiExecuteCommandRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *WorkspaceAPIService) ExecuteCommandExecute(r ApiExecuteCommandRequest) (*ExecuteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspaceAPIService.ExecuteCommand")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspace/{workspaceId}/{projectId}/toolbox/execute"
...
/*
ListFiles List files inside workspace project
...
*/
func (a *WorkspaceAPIService) ListFiles(ctx context.Context, workspaceId string, projectId string) ApiListFilesRequest {
	return ApiListFilesRequest{
		ApiService:  a,
		ctx:         ctx,
		workspaceId: workspaceId,
...
//
//	@return []FileInfo
func (a *WorkspaceAPIService) ListFilesExecute(r ApiListFilesRequest) ([]FileInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspaceAPIService.ListFiles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
